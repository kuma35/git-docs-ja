...
---------------------------------------------
....
注意: 3 番目のタブ定義では、 丸括弧(parentheses; `(` ... `)` ) を使用して `,` を `/` よりも優先する必要があることに注意してください。
--
