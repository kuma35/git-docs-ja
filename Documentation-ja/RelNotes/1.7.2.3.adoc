 ...
 * "git fetch --tags" did not fetch tags when remote.<nick>.tagopt was set to --no-tags. The command line option now overrides the configuration setting.
 ...
 * "git pack-refs --all --prune" did not remove a directory that has become empty.
