...
format.pretty::
	log コマンドや show コマンドや whatchanged コマンドの pretty 形式のデフォルト。 linkgit:git-log[1] や linkgit:git-show[1] や linkgit:git-whatchanged[1] を参照してください。
endif::with-breaking-changes[]
ifdef::with-breaking-changes[]
format.pretty::
	log コマンド や show コマンドの pretty 形式のデフォルト。 linkgit:git-log[1] や linkgit:git-show[1] を参照してください。
endif::with-breaking-changes[]
